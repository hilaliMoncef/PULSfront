    ...
    <nav class="my-2 my-md-0 mr-md-3">
      ...
      <span v-if="isLoggedIn && isAdmin">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownAdminMenu">
          <router-link class="dropdown-item p-2 text-dark" to="/users">Users</router-link>
          <router-link class="dropdown-item p-2 text-dark" to="/terminals">Terminaux</router-link>
          <router-link class="dropdown-item p-2 text-dark" to="/campaigns">Campagnes</router-link>
          <router-link class="dropdown-item p-2 text-dark" to="/customers">Clients</router-link>
        </div>
      </span>
    </nav>
