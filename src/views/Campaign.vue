  ...
  <div class="about mt-3">
    <div class="row mb-4">
      ...
      <div class="col text-right">
        <router-link to="/campaigns" class="btn btn-link">
          Retour à la liste
        </router-link>
      </div>
    </div>
        ...
        <div class="card card-rounded bg-dark text-white w-100">
          <div class="card-body d-flex">
            ...
            <div class="d-flex flex-column">
              ...
              <h1 class="display-4 text-white">{{ campaign.name }}</h1>
              <p class="w-100">
      ...
      <div class="col-4">
        <div class="card card-rounded">
          <div class="card-body">
            ...
            <div class="display-4">{{ totalToday }} €</div>
          </div>
        </div>
      </div>
      <div class="col-4">
      ...
      <div class="col-4">
        <div class="card card-rounded">
          <div class="card-body">
            ...
            <div class="display-4">{{ avgDonation }} €</div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card card-rounded">
          <div class="card-body">
            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="donation in lastDonations" :key="donation.id">
                  ...
                  <td>
                    ...
                    >
                      {{ donation.terminal.name }}</router-link
                    >
                  </td>
