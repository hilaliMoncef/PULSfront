<template>
	<div class="col-6 offset-3">
		<div v-if="donator">
			<div class="row">
				<h1 class="display-4 text-center">Bienvenue, <strong>{{ donator.name }}</strong> !</h1>
				<a>Ce n'est pas vous ?</a>
			</div>
			<div class="row mt-3 text-center">
				<button class="btn btn-primary" @click.prevent="gotoGame">Poursuivre</button>
			</div>
		</div>
		<div v-else-if="email">
			<div class="row mb-4">
				<h1 class="display-4 text-center">Vos informations</h1>
			...
			<form>
				...
				<div class="row mb-3">
					<div class="col">
						...
						<input type="text" class="form-control" v-model="newDonator.name" required="">
						<div class="invalid-feedback">
				...
				<div class="row mb-3">
					<div class="col">
						...
						<select class="custom-select d-block w-100" v-model="newDonator.gender" required>
							<option value="O">Non spécifié...</option>
				...
				<div class="row mt-3 text-center">
					<div class="col">
						<button class="btn btn-primary" @click="registerDonator">Donner</button>
					</div>
				</div>
			</form>
		</div>
